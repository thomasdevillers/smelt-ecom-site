export const POLICIES = {
  ...
  shipping: {
    ...
    timelines: [
      ...
      { area: "Regional / Outlying Areas", time: "3–5 business days" },
    ],
    tracking:
      "A tracking number will be emailed to you as soon as your order leaves us so you can trace your delivery online.",
  },
  returns: {
  ...
  signoff: "Warm regards, and smooth deliveries.",
};
